import { View, Text, Image, TextInput, TouchableOpacity, ImageSourcePropType, TextInputProps } from 'react-native'
...
const InputAndImageReusableScreen = ({ finputvalue, setfinputvalue, sinputvalue, setsinputvalue, screenName, toptext, imagesrc, btntext, onPress, finputtext, sinputtext, finputprops, sinputprops, category, setcategory }: InputAndImageReusableScreenProps): React.JSX.Element => {
